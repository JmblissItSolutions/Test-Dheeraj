    ...
    jQuery(".btn-accpt").click(function(){
     ...
     jQuery(".radio-btn input").click(function(){        
       ...
       jQuery("#skip").click(function(){ 
        jQuery('#popmake-4267').popmake('close');
       });
...
/*
** For SHow Checkbox on cross-up sell produvt checkout page
*
*
*/
add_action( 'edd_csau_download_before', 'add_checkbox' );
function add_checkbox(){
  ?>
  <input type="checkbox" name="add_direct" id="add_direct">
<?php
}
...
<script type="text/javascript">
  ...
  (function ($, document, undefined) {
    $('.reading-btn').click(function (e) { $('#popmake-4520').trigger('pumSetCookie'); });
  }(jQuery, document))
...
add_action( 'edd_after_checkout_cart', 'my_edd_csau_display_on_checkout_page' );
function my_edd_csau_display_on_checkout_page(){
  ?>
  <div class="my_class_checkout">
   <?php 
    echo edd_csau_html();
   ?> 
  </div>
...
add_action( 'wp_footer', 'custom_popup_scripts', 500 );
