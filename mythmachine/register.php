...
<div id="buddypress" class="reg-bp" >
<div class="form-bg">
	<?php
	...
	<div class="form-overlay" id="register-page">
		...
		<?php if ( 'request-details' == bp_get_current_signup_step() ) : ?>
			...
			<div class="tml" id="basic-details-sec">
					<!--<h4 class="widgettitle">signup</h4>-->
			...
			<?php if ( bp_is_active( 'xprofile' ) ) : ?>
				...
				<div class="register-sec" id="profile-details-sec">
			...
			<?php endif; ?>
				...
				<input type="text" name="signup_username" class="input" placeholder="Username" id="signup_username"  value="<?php bp_signup_username_value(); ?>" <?php bp_form_field_attributes( 'username' ); ?>/>
				...
				<input type="email" class="input" placeholder="Email" name="signup_email" id="signup_email" value="<?php bp_signup_email_value(); ?>" <?php bp_form_field_attributes( 'email' ); ?>/>
				...
				<input type="password"  placeholder="Password" name="signup_password" id="signup_password" value="" class="input" <?php bp_form_field_attributes( 'password' ); ?>/>
				...
				<input type="password" placeholder="Retype Password" name="signup_password_confirm" id="signup_password_confirm" value="" class="input" <?php bp_form_field_attributes( 'password' ); ?>/>
			...
			<?php if ( bp_get_blog_signup_allowed() ) : ?>
				...
				<div class="register-sec" id="blog-details-section">
            ...
            <div class="radio-btn"><input type="checkbox" id="agreed" name="agree-btn[]" required /><div class="check-bx"></div><label class="lab-bx">I agree to terms</label></div>
            <div class="error" id="radio-eror"></div>
			<div class="submit">
				<input type="submit" name="signup_submit" id="signup_submit" value="<?php esc_attr_e( 'Sign Me Up', 'buddypress' ); ?>" />
				<a class="tml-signup_" href="/login/">LOG IN</a>
			</div>
		...
		<?php if ( 'completed-confirmation' == bp_get_current_signup_step() ) : ?>
			...
			<div id="template-notices" role="alert" aria-atomic="true" class="input-left" >
...
<div class="social-right">
             <?php dynamic_sidebar( 'Social Login' ); ?> 
